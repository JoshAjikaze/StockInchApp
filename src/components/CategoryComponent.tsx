...
const CategoryComponent = ({ categoryProps }: TCategoryComponentProps) => {
    return (
        <Link to={categoryProps.url} className="flex flex-col items-center justify-center p-3 text-black no-underline rounded-lg border border-solid basis-1/3 border-LightGray">
