...
const ProductComponent = ({ product }: TComponentProps) => {
    ...
    return (
        <div className='relative flex gap-x-5 items-center text-Gray shadow-[0px_0px_6px_0px_rgba(0,0,0,0.3)] rounded-lg p-2'>
            ...
            <img src={product?.image || "https://placehold.co/100x100"} alt="" className='object-fill rounded-md size-16' />
                ...
                <div className="flex flex-col">
                    ...
                    {showOptions &&
                        <div className='space-y-3'>
                            <Link to={`/retailer-screen/editproduct/${product.id}`} className='flex items-center justify-between no-underline gap-x-5 text-Gray'>
                                {/* <span>Edit</span> */}
