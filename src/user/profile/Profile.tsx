  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between">
        <button onClick={() => { history.back() }} className="default-btn flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
          </svg>
        </button>
        <Link to="/" className="text-Yellow no-underline">Edit Profile</Link>
      </div>

      <div className="bg-black/0 min-h-[60vh] mt-16 flex flex-col items-center">
        <div className="flex flex-col items-center gap-y-5">
          <img src="https://placehold.co/100x100" alt="" className="size-20 rounded-full" />
          <p className="font-semibold text-xl text-Gray">Kunle Abina</p>
        </div>
        ...
        <section className="relative w-full md:w-[500px] space-y-5 mt-10">
          ...
          <div className="relative w-[95%] px-[2.5%] py-2 border-solid border-[1px] border-black/25 rounded-md flex items-center gap-5 ">
            <p>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10 stroke-LightGray">
          ...
          <div className="border-solid border-[1px] border-black/25 rounded-md">
            ...
            <hr className="w-[90%] bg-LightGray mx-auto" />
